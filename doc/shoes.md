...
```
{
    "dewu-brand_id_list": "{\"13\":\"Air Jordan\",\"144\":\"Nike\",\"4\":\"New Balance\",\"494\":\"addidas\"}", //得物品牌列表
    "site-description": "仅作为学习用，自买不炒，wink" //站点描述
}
```
...
|    | 必选 | 类型及范围 | 说明 |
| ----- | ----- | ------- | ---------- |
| key | true | string | 要设置的key |
| val | true | string | 要设置的值 |
